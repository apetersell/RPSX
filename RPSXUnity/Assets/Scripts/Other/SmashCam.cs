...
//		if (Vector3.Distance (Players [1].transform.position, Players [0].transform.position) < zoomDistance) 
//		{
//			Camera.main.orthographicSize = depth;
//		}
//
//		if (camZoom > zoomUpperLimit) {
//			camZoom = zoomUpperLimit;
//		}
//
//		if (camZoom < zoomLowerLimit) {
//			camZoom = zoomLowerLimit;
//		}
	}
}